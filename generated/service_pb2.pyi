...
class PersonalizedCarePlanRequest(_message.Message):
    ...
    class DomainDefinitionsEntry(_message.Message):
        ...
        def __init__(
            self,
            key: _Optional[str] = ...,
            value: _Optional[_Union[DomainLevels, _Mapping]] = ...,
        ) -> None: ...
    ...
    def __init__(
        self,
        client_data: _Optional[_Union[ClientData, _Mapping]] = ...,
        domain_definitions: _Optional[_Mapping[str, DomainLevels]] = ...,
    ) -> None: ...
...
class ClientData(_message.Message):
    ...
    def __init__(
        self,
        age: _Optional[int] = ...,
        living_situation: _Optional[str] = ...,
        education_level: _Optional[str] = ...,
        domain_name: _Optional[str] = ...,
        current_level: _Optional[int] = ...,
        level_description: _Optional[str] = ...,
    ) -> None: ...
...
class PersonalizedCarePlanResponse(_message.Message):
    ...
    def __init__(
        self,
        client_profile: _Optional[_Union[ClientProfile, _Mapping]] = ...,
        assessment_summary: _Optional[str] = ...,
        care_plan_objectives: _Optional[_Union[CarePlanObjectives, _Mapping]] = ...,
        interventions: _Optional[_Union[Interventions, _Mapping]] = ...,
        resources_required: _Optional[_Iterable[str]] = ...,
        success_metrics: _Optional[_Iterable[_Union[SuccessMetric, _Mapping]]] = ...,
        risk_factors: _Optional[_Iterable[_Union[RiskFactor, _Mapping]]] = ...,
        support_network: _Optional[_Iterable[_Union[SupportRole, _Mapping]]] = ...,
        review_schedule: _Optional[_Union[ReviewSchedule, _Mapping]] = ...,
        emergency_protocols: _Optional[_Iterable[str]] = ...,
        transition_criteria: _Optional[_Union[TransitionCriteria, _Mapping]] = ...,
    ) -> None: ...
...
class ClientProfile(_message.Message):
    ...
    def __init__(
        ...
        living_situation: _Optional[str] = ...,
        education_level: _Optional[str] = ...,
        assessment_domain: _Optional[str] = ...,
        current_level: _Optional[int] = ...,
        level_description: _Optional[str] = ...,
    ) -> None: ...
...
class CarePlanObjectives(_message.Message):
    ...
    def __init__(
        self,
        short_term_goals: _Optional[_Iterable[_Union[Goal, _Mapping]]] = ...,
        medium_term_goals: _Optional[_Iterable[_Union[Goal, _Mapping]]] = ...,
        long_term_goals: _Optional[_Iterable[_Union[Goal, _Mapping]]] = ...,
    ) -> None: ...
...
class Goal(_message.Message):
    ...
    def __init__(
        ...
        goal_title: _Optional[str] = ...,
        description: _Optional[str] = ...,
        specific_actions: _Optional[_Iterable[str]] = ...,
    ) -> None: ...
...
class Interventions(_message.Message):
    ...
    def __init__(
        self,
        daily_activities: _Optional[_Iterable[str]] = ...,
        weekly_activities: _Optional[_Iterable[str]] = ...,
        monthly_activities: _Optional[_Iterable[str]] = ...,
    ) -> None: ...
...
class SuccessMetric(_message.Message):
    ...
    def __init__(
        ...
        measurement_method: _Optional[str] = ...,
    ) -> None: ...
...
class SupportRole(_message.Message):
    ...
    responsibility: str
    def __init__(
        self, role: _Optional[str] = ..., responsibility: _Optional[str] = ...
    ) -> None: ...
...
class ReviewSchedule(_message.Message):
    ...
    def __init__(
        self,
        daily: _Optional[str] = ...,
        weekly: _Optional[str] = ...,
        monthly: _Optional[str] = ...,
        quarterly: _Optional[str] = ...,
    ) -> None: ...
